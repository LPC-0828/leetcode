...
//        System.out.println(search(new int[]{2}, 2));
    ...
    public int while循环(int[] nums, int target) {
    ...
    public int while进阶(int[] nums, int target) {
        int a = 0, b = nums.length - 1;
        while (a <= b) {
            int c = (a + b) / 2;
            if (nums[c] == target) {
